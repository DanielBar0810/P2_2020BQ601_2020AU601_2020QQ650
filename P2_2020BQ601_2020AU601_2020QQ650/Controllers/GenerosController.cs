...
namespace P2_2020BQ601_2020AU601_2020QQ650.Controllers
{
    public class GenerosController : Controller
    {
        ...
        public GenerosController(covidConnection context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Generos != null ? 
                          ...
                          Problem("Entity set 'covidConnection.Generos'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'covidConnection.Generos'  is null.");
            }
            var generos = await _context.Generos.FindAsync(id);
            if (generos != null)
            {
