...
namespace P2_2020BQ601_2020AU601_2020QQ650.Controllers
{
    ...
    {
        private readonly covidConnection _context;

        public DepartamentosController(covidConnection context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Departamentos != null ? 
                          ...
                          Problem("Entity set 'covidConnection.Departamentos'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'covidConnection.Departamentos'  is null.");
            }
            var departamentos = await _context.Departamentos.FindAsync(id);
            if (departamentos != null)
            {
